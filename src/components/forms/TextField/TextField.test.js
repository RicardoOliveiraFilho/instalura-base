  ...
  describe('when field is valid', () => {
    describe('and user is typing', () => {
      test('the value must be updated', () => {
        ...
        user.type(inputNome, 'ricardo fake name');

        expect(onChangeMock).toHaveBeenCalledTimes(17);
      });
    });
  });
  ...
  describe('when field is invalid', () => {
    test('displays the respective error message', () => {
      render(
        <TextField
          placeholder="Email"
          value="ricardo.fake.mail@gmail.com"
          onChange={() => {}}
          name="email"
          isTouched
      ...
      expect(inputEmail).toHaveValue('ricardo.fake.mail@gmail.com');
